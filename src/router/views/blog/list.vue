                  ...
                  <div class="col-xl-8">
                    <div>
                      ...
                      <div>
                        ...
                        <p class="text-muted">10 Apr, 2022</p>
                      ...
                      <div>
                        ...
                        <p class="text-muted">24 Mar, 2022</p>
                    ...
                    <div class="mt-5">
                      ...
                      <div class="list-group list-group-flush">
                        <router-link
                          ...
                          ><i class="mdi mdi-circle-medium me-1"></i> Dynamic Asset Managment 
                          vs Passive ETF vs Passive</router-link
                        >
                        ...
                        <router-link
                          to="/blog/detail"
                          class="list-group-item text-muted"
                          ><i class="mdi mdi-circle-medium me-1"></i> Deligation of Analysis 
                          And Execution</router-link
                        >
                      </div>
                    </div>
