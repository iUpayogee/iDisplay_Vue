  ...
  <Layout>
    ...
    <div class="row">
          ...
          <div class="card-body border-bottom">
            <div>
              <div class="row">
                <div class="col-sm-6">
                  <div>
                    <p class="text-muted mb-2">Net Asset Value</p>
                    <h5>$ 96,148.32 USD</h5>
                  </div>
                </div>
                <div class="col-sm-6">
              ...
              <ul class="verti-timeline list-unstyled">
                <li class="event-list">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <div>
                        <h5 class="font-size-14">Register An Account</h5>
                        <p class="text-muted">
                          Simply Go through the Onboarding Process to Gain 
                          Full Access.
                        </p>
                      </div>
                    </div>
                ...
                <li class="event-list">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <div>
                        <h5 class="font-size-14">Connect Banks</h5>
                        <p class="text-muted">
                          Establish Secure Connection to Your Local Bank, Where You can 
                          Make All Physical Withdrawls.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <li class="event-list">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      <div>
                        <h5 class="font-size-14">Select A Strategy</h5>
                        <p class="text-muted">
                          Dynamically Manage Your Assets
                          .
                        </p>
                      </div>
                    </div>
      ...
      <div class="col-xl-8">
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title mb-4">Open Crypto Positions</h4>
