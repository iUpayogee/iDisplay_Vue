              ...
              <div class="d-flex flex-column h-100">
                            ...
                            <ul class="list-unstyled mb-0">
                              <li>
                                <a href="#" class="d-flex align-items-center"
                                  ><span class="me-auto">iWeb</span></a
                                >
                              </li>
                              <li>
                                <a href="#" class="d-flex align-items-center"
                                  ><span class="me-auto">iStrategy</span>
                                  <i class="mdi mdi-pin ms-auto"></i
                                ></a>
                              </li>
                              <li>
                                <a href="#" class="d-flex align-items-center"
                                  ><span class="me-auto">iDatabase</span></a
                                >
                              </li>
                              <li>
                                <a href="#" class="d-flex align-items-center"
                                  ><span class="me-auto">iAdmin</span>
                                  <i class="mdi mdi-pin ms-auto"></i
                                ></a>
                              </li>
                            </ul>
                ...
                <div class="mt-auto">
                  <b-alert show dismissible variant="success">
                    ...
                    <div>
                      <h5 class="text-success">Developer Documents</h5>
                      <!-- <p></p> -->
                      <div class="text-center">
                        ...
                        >
                          Access Link <i class="mdi mdi-arrow-right"></i>
                        </button>
                      </div>
                    </div>
                  </b-alert>
