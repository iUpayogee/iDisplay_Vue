                      ...
                      <div class="text-center">
                        <h4 class="mb-3">
                          <i
                            ...
                            "
                          ></i
                          ><span class="text-primary">Dynamic</span>Asset
                          Managment
                        </h4>
                          ...
                          >
                            ...
                            <b-carousel-slide>
                              ...
                              <div>
                                ...
                                <p class="font-size-14 mb-0">- Upayogee User</p>
                              </div>
                            </b-carousel-slide>
                            ...
                            <b-carousel-slide>
                              <p class="font-size-16 mb-4">
                                " If Every Asset Manager is as supportive as
                                Arete Invest, Growth is a nice
                                experience. You guys are Wonderful. Keep up the
                                good work. "
                              </p>
                              <div>
                                <h4 class="font-size-16 text-primary">
              ...
              <div class="d-flex flex-column h-100">
                ...
                <div class="my-auto">
                  <div>
                    ...
                    <p class="text-muted">Get your free Upayogee account now.</p>
                  </div>
                ...
                <div class="mt-4 mt-md-5 text-center">
                  <p class="mb-0">
                    © {{ new Date().getFullYear() }} Upayogee Corp.
