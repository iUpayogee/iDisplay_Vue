          ...
          <div class="py-4 border-bottom">
            <div class="d-flex">
              ...
              <div class="flex-grow-1">
                <h5 class="font-size-15 mt-0 mb-1">Ojay Ojas</h5>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="font-size-14 mb-0">iWeb</h5>
                        </div>
                      </div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="font-size-14 mb-0">iReport</h5>
                        </div>
                      </div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="font-size-14 mb-0">iDatabase</h5>
                        </div>
                      </div>
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="#">
                      <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                          <h5 class="font-size-14 mb-0">iSelect</h5>
                        </div>
                      </div>
                    </a>
                  </li>
                ...
                <SimpleBar style="height: 410px">
                  <div>
                    ...
                    <ul class="list-unstyled chat-list">
                      <li>
                        <a href="#">
                          <h5 class="font-size-14 mb-0">Abhishek</h5>
                        </a>
                      </li>
                  ...
                  <div class="mt-4">
                    ...
                    <ul class="list-unstyled chat-list">
                      <li>
                        <a href="#">
                          <h5 class="font-size-14 mb-0">Bardiya Freeman</h5>
                        </a>
                      </li>
                    </ul>
                  </div>
