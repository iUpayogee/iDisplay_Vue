        ...
        <div class="card overflow-hidden">
            ...
            <div class="row">
              <div class="col-7">
                <div class="text-primary p-4">
                  <h5 class="text-primary">Free Registeration</h5>
                  <p>Register to Gain Full Access to Upayogee Dynamic Asset Management Tools.</p>
                </div>
              </div>
          ...
          <div class="card-body pt-0">
            ...
            <b-form class="p-2" @submit.prevent="tryToRegisterIn">
              ...
              <div class="mt-4 text-center">
                <p class="mb-0">
                  By registering you agree to the Upayogee Corp.
