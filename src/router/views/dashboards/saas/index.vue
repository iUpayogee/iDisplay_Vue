              ...
              <div class="col-lg-4 align-self-center">
                <div class="text-lg-center mt-4 mt-lg-0">
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div>
                        <p class="text-muted text-truncate mb-2">Net Value</p>
                        <h5 class="mb-0">165K</h5>
                      </div>
                    </div>
                    <div class="col-4">
                      <div>
                        <p class="text-muted text-truncate mb-2">%Invested</p>
                        <h5 class="mb-0">95%</h5>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
              <div class="col-7">
                <div class="text-primary p-3">
                  ...
                  <p>Upayogee Adminstrator Portal</p>

                  <ul class="ps-3 mb-0">
                    <!-- <li class="py-1">Call To Action</li>
                    <li class="py-1">Something Useful</li> -->
                  </ul>
                </div>
              </div>
